...
const BookingSkeleton = () => {
  return (
    <div className="min-h-screen flex font-sans bg-stone-50 animate-pulse">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-4 sm:p-8 md:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-3 text-center md:text-left">
            <div className="h-8 w-3/4 bg-gray-200 rounded-lg mx-auto md:mx-0"></div>
            <div className="h-4 w-1/2 bg-gray-200 rounded mx-auto md:mx-0"></div>
            <div className="h-4 w-2/3 bg-gray-200 rounded mx-auto md:mx-0"></div>
          </div>

          {/* Location Info */}
          <div className="bg-white border-l-4 border-gray-200 shadow-sm rounded-r-lg p-4 flex items-start gap-3">
